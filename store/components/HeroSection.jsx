    ...
    <section className="relative overflow-hidden pt-0 sm:pt-0 lg:pt-28 pb-8 sm:pb-10 lg:pb-16 lg:min-h-[80svh] lg:flex lg:items-end lg:justify-center">
      ...
      >
        ...
        >
          ...
          {/* Decorative lines */}
          <g opacity="0.2" stroke="#46a5e3" strokeWidth="2" fill="none">
        ...
        <div className="hero-glass-card text-center">
          ...
          >
            <motion.a
              ...
              className="btn-primary btn-modern btn-shine-sweep"
              whileHover={{ 
                scale: 1.05,
              ...
              style={{
                ...
                background: 'linear-gradient(135deg ,#46a5e3, #46a5e3)',
                color: '#fff', fontWeight: 700, fontSize: 16, textDecoration: 'none',
                boxShadow: '0 8px 28px -4px rgba(70,165,227,0.5)', whiteSpace: 'nowrap',
                position: 'relative',
                overflow: 'hidden',
              }}
            >
